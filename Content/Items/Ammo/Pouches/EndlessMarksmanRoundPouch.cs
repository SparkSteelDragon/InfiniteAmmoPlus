...
{
    public class EndlessMarksmanRoundPouch : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            AmmoUtils.SetAmmoDefaults(
                this,
                "MarksmanRound",                 // ammo item name
                width: 26,
                height: 34,
                rarity: ItemRarityID.LightRed,      // rarity
        ...
        public override void AddRecipes()
        {
            ...
            AmmoUtils.AddRecipeIngredient(recipe, "MarksmanRound", 3996, "CalamityMod");
