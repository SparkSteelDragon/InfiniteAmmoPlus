...
{
    public class EndlessHallowPointRoundPouch : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            AmmoUtils.SetAmmoDefaults(
                this,
                "HallowPointRound",                 // ammo item name
                width: 26,
                height: 34,
                rarity: ItemRarityID.Pink,      // rarity
        ...
        public override void AddRecipes()
        {
            ...
            AmmoUtils.AddRecipeIngredient(recipe, "HallowPointRound", 3996, "CalamityMod");
