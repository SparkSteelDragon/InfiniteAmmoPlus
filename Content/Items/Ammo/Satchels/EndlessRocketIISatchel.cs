...
{
    public class EndlessRocketIISatchel : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            AmmoUtils.AddRecipeIngredient(recipe, "RocketII", 3996);
        ...
        {
            AmmoUtils.TryOverrideProjectile("RocketII", weapon, ref type);
        }
    }
}
