...
{
    public class EndlessClusterRocketIISatchel : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            AmmoUtils.SetAmmoDefaults(
                this,
                "ClusterRocketII",                 // ammo item name
                width: 26,
                height: 34,
        ...
        public override void AddRecipes()
        {
            ...
            AmmoUtils.AddRecipeIngredient(recipe, "ClusterRocketII", 3996);
        ...
        {
            AmmoUtils.TryOverrideProjectile("ClusterRocketII", weapon, ref type);
        }
    }
}
